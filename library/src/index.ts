...
export { readCustomProperties, readCustomPropertyTypes, decodeIDPropertyAt, IDP_TYPE } from './idproperty.ts'
export type { IDPropertyValue, IDPropertyTypeName } from './idproperty.ts'
